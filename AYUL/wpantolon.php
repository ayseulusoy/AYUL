...
$products=$db->query("select * from urunkayit where urunkod=1",PDO::FETCH_OBJ)->fetchAll();

?>
<div class="middlecontainer">
	<?php foreach ($products as $product){ ?>
	<div class="img-zoom-container">
		<div class="urunimg"><img id="myimage" src="erkek_pantolon.jpg" width="400" height="500"></div>
