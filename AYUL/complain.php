...
<div class="middlecontainer">
  <div style="text-align:center">
    <h2>Şikayet Et</h2>
    <p>Lütfen şikayet ve önerilerinizi yazınız:</p>
  </div>
  <div class="row">
    <div class="column">
      <form method="post"  action="<?php $_PHP_SELF?>"  >
        ...
        <label for="subject"><b>Şikayet</b></label>
         <input type="text" id="subject" name="subject" placeholder="Şikayet ve Önerileriniz..">
        <button  id="submit1" name="submit1" style="padding:14px 20px; background-color:#f44336;">Şikayet Et</button>
      </form>
    </div>
  </div>
</div>
