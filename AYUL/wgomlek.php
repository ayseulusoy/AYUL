...
$products=$db->query("select * from urunkayit where urunkod=2",PDO::FETCH_OBJ)->fetchAll();
...
<div class="middlecontainer">
	...
	<div class="img-zoom-container">
		<div class="urunimg"><img id="myimage" src="kadin_gomlek.jpg" width="400 " height="500"></div>
